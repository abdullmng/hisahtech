                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputtext" name="name" aria-describedby="textHelp" value="{{ $admin->name }}">
                                    @if ($errors->has('name'))
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control" id="exampleInputEmail1" name="email" aria-describedby="emailHelp" value="{{ $admin->email }}" readonly>
                                    @if ($errors->has('email'))
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="role" id="role" class="form-control form-select">
                                        ...
                                        @foreach ($roles as $role)
                                            <option value="{{ $role }}" {{ $admin->role == $role ? 'selected' : ''}}>{{ ucwords(str_replace("_", " ", $role)) }}</option>
                                        @endforeach
                                    </select>
                                    @if ($errors->has('role'))
