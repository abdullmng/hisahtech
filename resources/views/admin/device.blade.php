                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" aria-describedby="textHelp" value="{{ $device->name }}">
                                    @if ($errors->has('name'))
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="brand" name="brand" aria-describedby="emailHelp" value="{{ $device->brand }}">
                                    @if ($errors->has('brand'))
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="number" name="ram_size" id="ram_size" class="form-control" value="{{ $device->ram_size }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="number" name="storage_size" id="storage_size" class="form-control" value="{{ $device->storage_size }}">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="user_id" id="user" class="form-control form-select">
                                        ...
                                        @foreach ($users as $user)
                                            <option value="{{ $user->id }}" {{ $device->user_id == $user->id ? 'selected' : '' }}>{{ $user->name }} ({{ $user->email }})</option>
                                        @endforeach
                                    </select>
                                </div>
                                @if (session('success'))
